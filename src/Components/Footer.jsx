...
const Footer = () => {
    ...
    return ( 
        <div  data-aos="fade-up top-center">
            <footer className="footer p-10 bg-base-200 text-base-content bg-gradient-to-r from-slate-300 via-blue-500 to-blue-700">
                <nav className='text-xl mx-auto'>
            ...
            <footer className="footer px-10 py-4  bg-base-200 text-base-content border-base-300 bg-gradient-to-r from-slate-300 via-blue-500 to-blue-700">
                <aside className="items-center grid-flow-col mx-auto">
                    ...
                    <p>Tech & Game Industries Ltd. <br />Providing reliable tech since 1992</p>
                </aside>
                <nav className="md:place-self-center md:justify-self-end mx-auto">
